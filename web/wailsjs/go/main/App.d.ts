...
export function ProbeAgentAvailability(arg1:string):Promise<bughub.AgentAvailability>;
...
export function SelectIncidentEvidence():Promise<main.IncidentEvidenceSelection>;
