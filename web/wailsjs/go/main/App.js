...
export function ProbeAgentAvailability(arg1) {
  return window['go']['main']['App']['ProbeAgentAvailability'](arg1);
}
...
export function SelectIncidentEvidence() {
  return window['go']['main']['App']['SelectIncidentEvidence']();
}
