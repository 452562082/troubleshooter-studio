...
export function AckIncidentWorkflowReminder(arg1) {
  return window['go']['main']['App']['AckIncidentWorkflowReminder'](arg1);
}
...
export function ListPendingIncidentWorkflowReminders() {
  return window['go']['main']['App']['ListPendingIncidentWorkflowReminders']();
}
